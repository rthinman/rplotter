...
const OFFSETX: i32 = 25;      // plotter units.
...
impl USCutter {
    ...
    fn new(port_name: &str, llx_mm: f64, lly_mm: f64, urx_mm: f64, ury_mm: f64) -> USCutter {
